...
m6.symppred.log <- ggpredict( m6.symp, term=c('weeks [all]','transfer.campus.f'), type = 'fe', back.transform = FALSE ) 

cbbPalette <- c("#000000", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7")
plot( m6.symppred, color = cbbPalette )

plot( m6.symppred.log, color = cbbPalette )
...
```{r}
cr.vals.role <- cr_setup( ctsr.use$roleemot, direction = "backward" )
